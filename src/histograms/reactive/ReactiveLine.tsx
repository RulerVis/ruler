...
export const ReactiveLine:Component<{
    fieldName:any,
    nextFieldName:any,
    lineData:any,
    ...
    return (
        <line
            ...
            stroke="#EDC948"
            stroke-width={width()}
            // class="hover:stroke-purple-600 hover:stroke-4"
            onClick={(event:MouseEvent)=>{clickLine(props.lineData,props.binsByCol,props.nextBinsByCol,props.barFilter,props.lineFilter,props.setLineFilter,props.setOriginalData,props.fieldName)}}
